...
class Auth extends AuthController
{
	...
	public function login()
	{
        ...
        //print_r([(bool)$this->request->getVar('remember'),$this->request->getVar('identity'),$this->request->getVar('password')]);
		...
		{  
			...
			if ($this->ionAuth->login($this->request->getVar('identity'), $this->request->getVar('password'), $remember))
			{
                ...
                if ($this->ionAuth->isAdmin()) {
				    ...
				    return redirect()->to('/participant/hari_ujian')->withCookies();
                }
