...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Plagiarism App - Management</title>
	...
	<div class="card-body">
      ...
      <div class="col-md-6 col-xl-4">
				<div class="card mb-4">
					<div class="card-body">
						...
						<h5 class="card-title text-primary">Article Checker</h5>
						<p class="card-text pb-3">Kelola Pengecekan </p>
						<a href="<?php echo base_url('management/submission');?>" class="btn btn-outline-primary">Klik disini</a>
					</div>
				</div>
			</div>
      ...
      <div class="col-md-6 col-xl-4">
				<div class="card mb-4">
					<div class="card-body">
						<!-- <img class="card-img-top mb-4 rounded" src="assets/img/elements/cc1a.jpg"> -->
						<h5 class="card-title text-primary">Article Database</h5>
						<p class="card-text pb-3">Kelola Basis Data </p>
						<a href="<?php echo base_url('management/database');?>" class="btn btn-outline-primary">Klik disini</a>
					</div>
				</div>
			</div>
      ...
      <div class="col-md-6 col-xl-4">
				<div class="card mb-4">
					<div class="card-body">
						...
						<p class="card-text pb-3">Kelola Pengguna </p>
						<a href="<?php echo base_url('management/users');?>" class="btn btn-outline-primary">Klik disini</a>
					</div>
				</div>
			</div>
