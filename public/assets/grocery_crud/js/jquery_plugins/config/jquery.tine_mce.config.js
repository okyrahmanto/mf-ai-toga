	$(function() {
		...
		var upload_path = window.location.origin + '/signup/postAcceptor';
		var tinymce_options = {
				...
				*/
				...
				plugins: 'image code charmap table',
				toolbar: 'undo redo | image code | charmap | table tabledelete | tableprops tablerowprops tablecellprops | tableinsertrowbefore tableinsertrowafter tabledeleterow | tableinsertcolbefore tableinsertcolafter tabledeletecol',
