<aside class="left-sidebar bg-sidebar">
          <div id="sidebar" class="sidebar sidebar-with-footer">
            <!-- Aplication Brand -->
            <div class="app-brand">
              <a href="/index.html" title="Plagiarism Dashboard">
              <img class="brand-icon" width="30"
                  height="33" src="<?php echo base_url(); ?>/backend-asset/img/logo_plagiarism.png" alt="User Image">
                <!--<svg
                  class="brand-icon"
                ...
                <span class="brand-name text-truncate">Plagiarism</span>
              </a>
            </div>
            ...
            <div class="" data-simplebar style="height: 100%;">
              ...
              <li class="">
                        <a class="sidenav-item-link" href="<?php echo base_url('management');?>">
                ...
                <li class="has-sub ">
                  ...
                  <ul class="collapse " id="app" data-parent="#sidebar-menu">
                    <div class="sub-menu">
                      ...
                      <li class="">
                        <a class="sidenav-item-link" href="<?php echo base_url('management/submission');?>">
                          <span class="nav-text">Article Checker</span>
                        </a>
                      </li>

                      <li class="">
                        <a class="sidenav-item-link" href="<?php echo base_url('management/database');?>">
                          <span class="nav-text">Article Database</span>
                        </a>
                      </li>

                      <li class="">
                        <a class="sidenav-item-link" href="<?php echo base_url('management/users');?>">
